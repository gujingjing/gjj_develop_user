 ...
 */
package com.nhaarman.swipedismiss.contextualundo;
...
import com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.*;
...
public class ContextualUndoAdapter extends BaseAdapterDecorator implements ContextualUndoListViewTouchListener.Callback {
    ...
    private com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView mCurrentRemovedView;
    ...
    public final View getView(final int position, final View convertView, final ViewGroup parent) {
        final ViewHolder vh;
        com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView contextualUndoView = (com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView) convertView;
        if (contextualUndoView == null) {
            contextualUndoView = new com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView(parent.getContext(), mUndoLayoutId, mCountDownTextViewResId);
    ...
    public void onViewSwiped(final long dismissViewItemId, final int dismissPosition) {
        com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView contextualUndoView = getContextualUndoView(dismissViewItemId);
        if (contextualUndoView == null) {
    ...
    private com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView getContextualUndoView(final long dismissViewItemId) {
        com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView contextualUndoView = null;

        AbsListView listView = getAbsListView();
        int childCount = listView.getChildCount();
        for (int i = 0; i < childCount; i++) {
            View child = listView.getChildAt(i);
            if (child instanceof com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView) {
                com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView listItem = (com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView) child;
    ...
    private void setCurrentRemovedView(final com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView currentRemovedView) {
    ...
    private void performRemovalIfNecessary() {
        ...
        com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView currentRemovedView = getCurrentRemovedView(mCurrentRemovedView, mCurrentRemovedId);
    ...
    private com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView getCurrentRemovedView(final com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView currentRemovedView, final long itemId) {
        com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView result = currentRemovedView;
        if (result == null ||
    ...
    private void swipeView(final View view, final int dismissPosition) {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(final Animator animator) {
                onViewSwiped(((com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView) view).getItemId(), dismissPosition);
            }
        });
        animator.start();
    }
    ...
    private class RemoveViewAnimatorListenerAdapter extends AnimatorListenerAdapter {
        ...
        private com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView mDismissView;
        private final long mDismissViewId;
        private final int mOriginalHeight;

        public RemoveViewAnimatorListenerAdapter(final com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView dismissView, final long dismissViewId) {
        ...
        private com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView getViewBeingAnimated() {
            com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView newDismissView = getCurrentRemovedView(mDismissView, mDismissViewId);
    ...
    private class RemoveViewAnimatorUpdateListener implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(final ValueAnimator valueAnimator) {
            com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView dismissView = mParentAdapter.getViewBeingAnimated();
            if (dismissView != null) {
    ...
    private class UndoListener implements View.OnClickListener {
        ...
        private final com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView mContextualUndoView;

        public UndoListener(final com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView contextualUndoView) {
    ...
    private class HierarchyChangeListener implements ViewGroup.OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(final View parent, final View child) {
            ...
            if (vh != null && mCurrentRemovedId > 0 && vh.mItemId == mCurrentRemovedId) {
                mCurrentRemovedView = (com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView) child;
            }
        }
    ...
    private static class ViewHolder {
        final com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView mContextualUndoView;
        ...
        ViewHolder(final com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView contextualUndoView) {
            mContextualUndoView = contextualUndoView;
