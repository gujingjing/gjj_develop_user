...
/**
 * An {@link OnTouchListener} for the {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter}. Don't use
...
public class ContextualUndoListViewTouchListener implements SwipeOnTouchListener {
    ...
    private boolean handleDownEvent(final View view, final MotionEvent motionEvent) {
        ...
        if (mDownView != null && mDownView instanceof com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoView) {
